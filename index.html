    ...
    <nav id="mainNav" class="navbar navbar-default navbar-fixed-top navbar-custom">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand" href="#page-top">Wolf Security</a>
            </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="intro-text">
                        <h1 class="name">Wolf Security</h1>
                        <hr class="star-light">
                        <span class="skills">Suporte técnico -  Auditoria de sistemas</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4 col-lg-offset-2">
                    <p>Fundada em 2016, a Wolf Security é uma empresa de tecnologia voltada para as áreas de: Padrões de protocolos em segurança da informação, Suporte técnico, Desenvolvimento e hospedagem de sites pessoais & profissionais, auditoria de sistemas utilizando técnicas e ferramentas de um "atacante" real em cenários reais e controlados.</p>
                </div>
                <div class="col-lg-4">
                    <p>Não importa se a sua empresa é de porte grande ou micro-empresa. Nossos serviços é destinado à aqueles que querem aproveitar o máximo do que a tecnologia tem a oferecer, seguindo normas,padrões dentro deste universo imenso que é a tecnologia da informação.</p>
                </div>
                <!-- #Butão de Donwload
    ...
    <footer class="text-center">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="footer-col col-lg-8">
                        <h3>Sobre nós</h3>
                        <p>segurança da informação, Suporte técnico, Desenvolvimento e hospedagem de sites pessoais & profissionais, auditoria de sistemas utilizando técnicas e ferramentas de um "atacante" real em cenários reais e controlados.</p>
                    </div>
                </div>
            </div>
        </div>
        <div class="footer-below">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        Copyright &copy; Wolf Security 2017
                    </div>
                </div>
            </div>
        </div>
